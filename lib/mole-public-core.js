 ...
 * comportement, seul le stockage change (kvGet/kvPut via l'API REST Cloudflare, voir
 * cloudflare-kv.js, au lieu du binding env.RECOS_KV natif des Workers).
 */
