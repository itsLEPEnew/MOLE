 ...
 * cours"). Maintenant : on interroge NOTRE base (~30 ms), et tout ce qu'on découvre y est
...
/** Ingère en parallèle une liste d'albums Deezer (résultats de recherche, discographie...). */
